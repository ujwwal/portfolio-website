      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-10 h-16 flex items-center justify-between">
        ...
        >
          ...
          <span className="font-mono text-[13px]">
            alex.chen<span className="text-neutral-400">/ai-engineer</span>
          </span>
        </button>
      ...
      <div className="relative max-w-[1400px] mx-auto px-6 md:px-10 mt-16 lg:mt-24">
        <div className="bg-neutral-950 text-neutral-300 font-mono text-[12px] p-5 border border-neutral-800">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-neutral-500">~/alex — zsh</span>
          </div>
          <div className="text-neutral-500">$ whoami --role --stack --attitude</div>
          <div className="text-neutral-300 mt-1">ai_engineer + data_scientist · py/ts/sql · ships boring tools that work.</div>
        </div>
      </div>
    </section>
  );
      ...
      <div className="lg:col-span-4">
        ...
        <div className="mt-8 space-y-2 font-mono text-[12px]">
          {[
            ...
            ["works with", "small product teams"],
    ...
    <div className="max-w-[1400px] mx-auto px-6 md:px-10 grid lg:grid-cols-12 gap-10">
      <div className="lg:col-span-4">
        ...
        <p className="mt-6 text-[15px] leading-relaxed text-neutral-400 max-w-sm">
          Breadth across the stack, depth in LLM apps and the data layer underneath.
        </p>
      </div>
  ...
  <section id="experience" className="relative py-24 lg:py-28 border-t border-neutral-200 bg-neutral-100/60">
    <div className="max-w-[1400px] mx-auto px-6 md:px-10 grid lg:grid-cols-12 gap-10">
      <div className="lg:col-span-4">
        ...
        <h2 className="font-plex font-semibold text-5xl lg:text-6xl leading-[0.95] tracking-tight text-neutral-950">
          Seven years,
          <br /> four <span className="italic font-normal text-neutral-500">chapters</span>.
        </h2>
      </div>
  ...
  <section id="writing" className="relative py-24 lg:py-28 border-t border-neutral-200">
    <div className="max-w-[1400px] mx-auto px-6 md:px-10">
      <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 mb-12">
        ...
        <a href="#" className="font-mono text-[12px] link-underline text-neutral-700 inline-flex items-center gap-1">
...
const Contact = () => {
  ...
  const onSubmit = async (e) => {
    ...
    if (!form.name || !form.email || !form.message) {
      toast({ title: "Missing fields", description: "Fill name, email and message." });
      return;
    }
    setSending(true);
    await new Promise((r) => setTimeout(r, 600));
    setSending(false);
    toast({ title: "Message queued locally", description: "Frontend-only for now." });
          ...
          <form onSubmit={onSubmit} className="bg-neutral-900 border border-neutral-800 p-8">
              ...
              {[
                ...
                <div key={f.key}>
                  ...
                  <Input
                    ...
                    placeholder={f.ph}
                    className="mt-2 bg-transparent border-0 border-b border-neutral-700 rounded-none px-0 text-neutral-100 placeholder:text-neutral-600 focus-visible:ring-0 focus-visible:border-neutral-50"
                  />
                </div>
              ))}
            </div>
            <div className="mt-5">
              ...
              <Textarea
                ...
                className="mt-2 min-h-[140px] bg-transparent border-0 border-b border-neutral-700 rounded-none px-0 text-neutral-100 placeholder:text-neutral-600 focus-visible:ring-0 focus-visible:border-neutral-50 resize-none"
              />
            </div>
  ...
  <footer className="bg-neutral-950 text-neutral-400 border-t border-neutral-800">
    <div className="max-w-[1400px] mx-auto px-6 md:px-10 py-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
      <div className="flex items-center gap-3">
        ...
        <span className="font-mono text-[11px]">alex.chen<span className="text-neutral-600">/ai-engineer</span></span>
      </div>
...
const DesignA = () => {
  ...
  useEffect(() => {
    const tick = () => {
      ...
      setClock(new Intl.DateTimeFormat("en-GB", opts).format(new Date()) + " PT");
    };
    tick();
